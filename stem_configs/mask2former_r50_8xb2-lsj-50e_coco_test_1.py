...
data_root = './Stem_Segmentation/flowers'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='valid/_annotations_coco_1.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file='./Stem_Segmentation/flowers/valid/_annotations_coco_1.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
...
train_dataloader = dict(
    ...
    batch_size=2,
    dataset=dict(
        ann_file='train/_annotations_coco_1.json',
        backend_args=None,
